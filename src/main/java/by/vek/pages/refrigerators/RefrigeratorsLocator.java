...
public class RefrigeratorsLocator {
    ...
    public static final String LINK_BAGS_REFRIGERATORS = "//a[@href=\"/bags_refrigerators/20154/\"]";
    public static final String LINK_FREEZERS_LARI = "//a[@href=\"/freezers/303184/\"]";
    public static final String LINK_SLATE_MAGNETS = "//a[@href=\"/easels_drawing_boards/778319/\"]";
}
